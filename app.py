...
# Cash-Guthaben direkt aus Auszug
...
# --- SEITENLEISTE (OHNE MANUELLE GELD-EINGABE) ---
with st.sidebar:
    ...
    # Cash-Guthaben nur als Information (Read-Only)
...
# TAB 4: TOP 5 KAUFEMPFEHLUNGEN (PORTFOLIO-ERWEITERUNG)
with tab4:
