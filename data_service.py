...
def get_stock_data(portfolio_list):
  ...
  for item in portfolio_list:
    ...
    if not sector or sector == "Technologie":
      ...
      elif "PANW" in t: sector = "Cyber-Sicherheit"
      elif "AVGO" in t: sector = "Netzwerk & Halbleiter"
      elif "TSM" in t: sector = "Chipherstellung (Foundry)"
      elif "RHM" in t: sector = "Verteidigung & Rüstung"
      elif "NVO" in t: sector = "Pharma & Gesundheit"
